...
public final class Settings implements SharedPreferences.OnSharedPreferenceChangeListener {
   ...
   public static final String PREF_VARIABLE_TOOLBAR_DIRECTION = "var_toolbar_direction";
    ...
    public static final String PREF_NUMPAD_FONT_SCALE = "numpad_font_scale";
    ...
    public static final String PREF_SUGGEST_RECENT_SCREENSHOTS = "suggest_recent_screenshots";
